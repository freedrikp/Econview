	...
	public static Object[] showEditDialog(final Object[] accountValues,
		...
		do {
			...
			JDateChooser dateSelector = new JDateChooser(selectedDate,
					new SimpleDateFormat(Utilities
							.getConfig("FULL_DATE_FORMAT")).toPattern());
			...
			scrollPane.setPreferredSize(new Dimension(Integer
					.parseInt(Utilities
							.getConfig("ADD_TRANSACTION_PANEL_HEIGHT")),
					Integer.parseInt(Utilities
							.getConfig("ADD_TRANSACTION_PANEL_WIDTH"))));

			result = JOptionPane.showConfirmDialog(null, scrollPane,
